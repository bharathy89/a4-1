...
int CNF :: BuildQueryOrder (OrderMaker &left, OrderMaker &right, OrderMaker &center) 
{
    ...
    for (int i=0; i<right.numAtts; i++) 
    {
        ...
        for (int j = 0; j < numAnds; j++) 
        {
            ...
            {
                if (   (orList[j][0].whichAtt2  == right.whichAtts[i]) 
                    && (orList[j][0].attType    == right.whichTypes[i]) )
                    
                {
                    left.whichAtts[left.numAtts]        = right.whichAtts[i];
                    left.whichTypes[left.numAtts]       = right.whichTypes[i];
                    left.numAtts++;
                    center.whichAtts[center.numAtts]    = orList[j][0].whichAtt1;
                    center.whichTypes[center.numAtts]   = orList[j][0].attType;
                    center.numAtts++;
                    broke = true;
                    break;
                }
            ...
            {
                if (   (orList[j][0].whichAtt1  == right.whichAtts[i]) 
                    && (orList[j][0].attType    == right.whichTypes[i]) )
                    
                {
                    ...
                    left.whichTypes[left.numAtts]       = right.whichTypes[i];
                    left.numAtts++;
                    center.whichAtts[center.numAtts]    = orList[j][0].whichAtt2;
                    center.whichTypes[center.numAtts]   = orList[j][0].attType;
                    center.numAtts++;
                    broke = true;
                    break;
